      ...
      <div className=" overflow-hidden ">
        <div className='  md:p-10'>
          ...
          <div>
            ...
            <div className="bg-white shadow  mx-auto  shadow-black rounded-lg p-4 md:p-8">
            ...
            <div className=" mt-4  mx-auto h-[600px] overflow-y-scroll text-center bg-white rounded-lg  md:pr-4 ">

              {
                companydata.map((item) => {
                  return (
                    <div className="border mb-5 p-5 shadow-md shadow-black rounded-lg">
